<template>
  <div id="app">
    <div class="tourism-content">
      <el-header style="width: 100%; height: 153px; padding:0;min-width:1200px;" class='top-header'>
        <el-row>
        ...
        <el-row class="el-row-header">
          <el-col :span="16" :offset="2">
            <div class="grid-content">
              <el-menu background-color="#4ce230" text-color="#fff" active-text-color="#ffd04b" :default-active="activeIndex" class="el-menu-header" mode="horizontal" :router="true">
      ...
      <el-footer style="width: 100%; height: 60px;background-color:#3ae6ae;" class='bottom-footer'>
        <p>© 2018 广东省徐闻县光之影 dhlsp</p>
      </el-footer>
    </div>
  </div>
</template>
...
export default {
  ...
  mounted: function () {
    ...
    this.$notify({
      title: '2018新年出游计划',
      message: h('div', {style: 'color:red;font-weight: bold;font-size:30px;'}, '全场最高立减五百'),
      duration: 50000
    })
  },
  mothods: {
